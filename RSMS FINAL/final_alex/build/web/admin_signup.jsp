        ...
        try {
            ...
            if ("login".equals(formType)) {
                ...
                if (!password.equals(confirmPassword)) {
                    ...
                    ps = con.prepareStatement("SELECT * FROM admins WHERE email= ? AND firstname = ? AND lastname = ? AND password = ?");
                ...
                if (!password.equals(confirmPassword)) {
                    ...
                    ps = con.prepareStatement("SELECT id FROM admins WHERE firstname = ? OR email = ?");
                    ps.setString(1, firstname);
                    ps.setString(2, email);
                    rs = ps.executeQuery();

                    if (rs.next()) {
                        errorMessage = "Firstname or email is already taken.";
                    } else {
                        ps = con.prepareStatement("INSERT INTO admins (firstname, lastname, password, email) VALUES (?, ?, ?, ?)");
                        ps.setString(1, firstname);
            ...
            errorMessage = "Firstname or email already exists.";
        } catch (Exception e) {
            e.printStackTrace();
...
<!--                <li><a href="#" class="link active">Home</a></li>
        ...
        <div class="nav-button">
            ...
            <button class="btn" id="adminBtn" onclick="student()">Student</button>
        </div>
